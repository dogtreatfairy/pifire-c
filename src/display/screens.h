...
typedef enum { PF_SCR_MAIN = 0, PF_SCR_MENU, PF_SCR_SETPOINT, PF_SCR_MESSAGE, PF_SCR_POWER, PF_SCR_NETINFO } pf_screen;
...
typedef enum {
	...
	PF_MI_SHUTDOWN, PF_MI_STOP, PF_MI_CLEAR, PF_MI_NETINFO, PF_MI_POWER, PF_MI_BACK
} pf_menu_id;

/* the power screen's own entries */
typedef enum { PF_PW_RESTART = 0, PF_PW_SHUTDOWN, PF_PW_BACK, PF_PW_COUNT } pf_power_id;
...
typedef struct {
	...
	int power_index;         /* highlighted row on the power screen */
